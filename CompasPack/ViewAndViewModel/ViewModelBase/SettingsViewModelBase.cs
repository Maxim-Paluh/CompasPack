...
namespace CompasPack.ViewModel
{
    ...
    public class SettingsViewModelBase<TSettings, TWrapper, TSettingsHelper> : ViewModelBase, ISettingsViewModel
        where TSettings : class, ICloneable, new()
        where TWrapper : ModelWrapper<TSettings>, new()
        where TSettingsHelper : SettingsFileProviderBase<TSettings>      
    {
        #region Properties
        ...
        #region Constructors
        public SettingsViewModelBase(IMessageDialogService messageDialogService, TSettingsHelper settingsHelper)
        {
